...
export function BroadCastTag() {
  ...
  return (
    <span
      ...
      className="transtion-all duration-[600ms] w-[105px] cursor-pointer px-[14px] h-8 rounded-3xl text-orange-200 bg-orange-600 font-manrope font-medium text-sm flex items-center gap-[6px] hover:bg-orange-200 hover:text-white"
    >
      <span
        className={`${
