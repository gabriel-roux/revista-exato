        ...
        {isFree && (
          <span
            className={`absolute rounded-l-md w-[35px] h-[38px] bg-gray-100 ${
              isHover
                ? 'bg-orange-200 rounded-l-none w-[84px] after:content-[""] after:absolute after:border-t-[19px] after:border-b-[19px] after:border-l-[19px] after:border-t-orange-200 after:border-b-orange-200 after:border-l-[transparent] after:top-1/2 after:-translate-y-1/2 after:left-[-18px] after:transition-all after:duration-500'
          ...
          >
            <LockKeyOpen size={16} className="text-gray-500" weight="fill" />
            {
              <span
